...
![npm](https://img.shields.io/npm/v/ai-lazy-load)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-lazy-load)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Lazy loading implementation utilities for performance optimization

Lazy loading utility generator. Creates optimized loading strategies for images and components.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-lazy-load.svg)](https://badge.fury.io/js/ai-lazy-load)
